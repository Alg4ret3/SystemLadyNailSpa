...
"")
        ...
        self.LabelImgNavbar.setMinimumSize(QtCore.QSize(80, 100))
        self.LabelImgNavbar.setMaximumSize(QtCore.QSize(260, 50))
...
"")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("assets/iconos/Egreso.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.BtnEgreso.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("assets/iconos/Respaldo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.BtnRespaldo.setIcon(icon3)
...
"")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("assets/iconos/Productos.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("assets/iconos/Facturas.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.BtnFacturas.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("assets/iconos/Reportes.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("assets/iconos/Clientes.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        spacerItem = QtWidgets.QSpacerItem(20, 320, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("assets/iconos/Usuarios.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.BtnControlUsuario.setIcon(icon8)
...
"")
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("assets/iconos/perfil.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"font-size: 14px;")
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("assets/iconos/cerrar-sesion.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
