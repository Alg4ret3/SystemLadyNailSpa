...
"}")
        ...
        self.gridLayout_5.addWidget(self.BtnGenerarTicket, 2, 2, 1, 1)
        self.BtnImprimirFactura = QtWidgets.QToolButton(self.widget)
        self.BtnImprimirFactura.setMinimumSize(QtCore.QSize(250, 50))
        self.BtnImprimirFactura.setMaximumSize(QtCore.QSize(250, 50))
        self.BtnImprimirFactura.setStyleSheet("QToolButton { background-color: black; color: white; font-size: 22px; }")
        self.BtnImprimirFactura.setObjectName("BtnImprimirFactura")
        self.gridLayout_5.addWidget(self.BtnImprimirFactura, 2, 4, 1, 1)
...
"}")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("assets/iconos/editar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.BtnEditarFactura.setIcon(icon1)
    ...
    def retranslateUi(self, Form):
        ...
        self.BtnGenerarTicket.setText(_translate("Form", "   Ver Ticket PDF"))
        self.BtnImprimirFactura.setText(_translate("Form", "   Imprimir"))
